...
import CreatePage from '@/app/[lang]/(dashboard)/inventory/categories/new/page'

/**
 * Intercepts /inventory/categories/new so it opens as a dialog over the list it was
