...
import CreatePage from '@/app/[lang]/(dashboard)/procurement/suppliers/new/page'

/**
 * Intercepts /procurement/suppliers/new so it opens as a dialog over the list it was
