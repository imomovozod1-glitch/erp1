...
import { Search, ShoppingCart, MoreHorizontal, Eye, Sparkles } from 'lucide-react'
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => router.push(`/${lang}/procurement/purchase-orders/${order.id}`)}>
