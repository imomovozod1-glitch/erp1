...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        // Unlike shadcn's canonical template, this project's Popover isn't
        // Radix — its Popup already paints an opaque bg-popover, and making
        // the calendar transparent on top of it caused page content behind
        // the portal to bleed through visually. Keep the calendar's own
